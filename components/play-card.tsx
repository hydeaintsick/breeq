...
export function PlayCard({
  ...
  preview?: boolean;
  /** A small glyph after the title (the Earn card's ETH mark). Decorative; the title carries the meaning. */
  titleMark?: ReactNode;
}) {
  ...
  const copy = (
    <>
      ...
      <div className="mode-card-copy">
        ...
        <h2 className="mt-2 flex items-center gap-2 text-3xl font-semibold tracking-tight text-white">
          {title}
          {titleMark ?? null}
        </h2>
