...
import { setTutorialEnabled } from "@/app/actions/tutorial";

/** Admin switch: does every player go through the how-to-play run before the story? */
export function TutorialSetting({ enabled }: { enabled: boolean }) {
  ...
  return (
    <div className="mt-4 flex flex-wrap items-center gap-3">
      ...
      <button
        ...
        aria-pressed={shown}
      >
        {shown ? "Turn the tutorial off" : "Turn the tutorial on"}
      </button>
    </div>
  );
}
